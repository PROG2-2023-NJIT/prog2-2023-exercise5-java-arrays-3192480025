...
public class FlightBooking {
    ...
    public FlightBooking(String passengerFullName, LocalDate depart, LocalDate returnDate, int childPassengers,
            int adultPassengers) {
    ...
    public void reserveTickets(int number) {
        ...
        for (int repeat = number; repeat > 0; --repeat) {
            System.out.println("Dear passenger please input the following messages for the No." + (number + 1 - repeat)
                    + "passenger");
        ...
        System.out.println(
                "Please choice the TripSource( 1.Nanjing, 2.Beijing, 3.Oulu, 4.Helsinki) NUMBER in STRING form:");
        String tripSource = scanner.nextLine();
        setTripSource(tripSource);
        System.out.println(
                "Please choice the TripDestination( 1.Nanjing, 2.Beijing, 3.Oulu, 4.Helsinki Not be the same as the TripSource) NUMBER in STRING form:(Number of tripSource,Number of tripDestination)");
    ...
    public void setFlightID() {
        ...
        String flightID = String.valueOf(chars.charAt(0)) + String.valueOf(chars.charAt(1))
                + String.valueOf(chars.charAt(2)) + String.valueOf(midNumber) + String.valueOf(chars.charAt(3))
                + String.valueOf(chars.charAt(4));
